$(function(){
  $('.btn').click(function(){
    var quotes = [["Too many people spend money they earned..to buy things they don’t want..to impress people that they don’t like. ","Will Rogers"],
...
["My formula for success is rise early, work late and strike oil. ","JP Getty"]];
 ...
        document.getElementById("demo").innerHTML = "<i class='fa fa-quote-right' aria-hidden='true'></i> "+quotes[i][0] +"<br><i>-"+quotes[i][1]+"</i>";
        $(".lnk").attr("href", "https://twitter.com/intent/tweet" + "?text=" +quotes[i][0] + " -" +quotes[i][1]);
         $("#quotepanel").delay(10000).css("background-color","#"+((1<<24)*Math.random()|0).toString(16));
        }
  })
})
